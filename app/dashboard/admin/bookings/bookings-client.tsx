            ...
            <div className="block md:hidden">
              <div className="space-y-4 p-4">
                {bookings.map((booking) => (
                  <Card key={booking.id} className="shadow-sm border border-gray-200 dark:border-gray-600">
                    <div className="p-4">
                      {/* Header with checkbox and dropdown */}
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex flex-col">
                            <span className="font-semibold text-gray-900 dark:text-white">
                              {new Date(booking.scheduledDate).toLocaleDateString('sv-SE')}
                            </span>
                        ...
                        <div className="relative">
                          <button
                            onClick={() => {
                              // Simple toggle for demo - in real app you'd use state
                              const menu = document.getElementById(`dropdown-${booking.id}`);
                              if (menu) {
                          ...
                          <div
                            ...
                            className="hidden absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 z-50"
                          >
                            <div className="py-1">
                              <Link
