            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Card className="p-6 text-center hover:shadow-lg transition-shadow">
                  ...
                  <p className="text-gray-600">A, C, D, BE - Kontakta oss för vägledning med råd och tips</p>
                </Card>
              </div>
            </div>
              ...
              <div className="mb-12">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <Card className="p-4 bg-gray-50">
                    ...
                    <p className="text-sm text-gray-700">A, B96, BE, C och D - kontakta oss för tips och råd</p>
                  </Card>
                </div>
              </div>
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  <div className="text-center lg:text-left">
                    <div className="mb-6">
                      ...
                      <p className="text-gray-600 mb-4">Snabbt, säkert och enkelt</p>
                      <div className="space-y-2">
                        <p className="text-lg font-semibold text-gray-800">Swish-nummer:</p>
                        <p className="text-3xl font-bold text-gray-800 tracking-wider">123 273 20 71</p>
                      </div>
                    </div>
