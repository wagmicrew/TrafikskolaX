...
import { Loader2, Play, TestTube, RefreshCcw, Eye, Copy, Trash2 } from 'lucide-react';
        ...
        <DialogContent className="max-w-3xl">
          ...
          <div className="rounded-md border border-white/10 bg-black/40">
            <ScrollArea className="h-[420px] p-3">
              <pre className="text-xs leading-relaxed text-slate-200 whitespace-pre-wrap">{previewItem?.preview}</pre>
            </ScrollArea>
          </div>
        </DialogContent>
      </Dialog>
