...
import { Loader2, Search, RefreshCw, Smartphone, Calendar, User, Package } from 'lucide-react';
...
export default function SwishPaymentsClient() {
  ...
  const fetchPayments = async () => {
    try {
      ...
      // Use the same admin payments endpoint but filter for Swish
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-8 text-gray-400">
              ...
              <p>Inga Swish-betalningar hittades</p>
            </div>
          ) : (
