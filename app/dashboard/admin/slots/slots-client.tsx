    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-1">
            Hantera tillgängliga tidsluckor, blockerade tider och extra tidsluckor
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Button
            ...
            disabled={isUpdating}
          >
            {isUpdating ? <Loader2 className="w-4 h-4 animate-spin mr-2" /> : <Trash2 className="w-4 h-4 mr-2" />}
            Återställ (Mån–Fre)
          </Button>
        </div>
      </div>
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[100]">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="flex items-center gap-3 p-6 border-b border-gray-200 dark:border-gray-700">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Varning</h3>
            </div>
            <div className="p-6">
              <p className="text-gray-700 dark:text-gray-300 mb-6">{warning}</p>
      ...
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as any)} className="w-full">
        <TabsList className="grid w-full grid-cols-3 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
          <TabsTrigger value="slots" className="text-gray-600 dark:text-gray-400 data-[state=active]:bg-blue-500 data-[state=active]:text-white">
            Tidsluckor
          </TabsTrigger>
          <TabsTrigger value="blocked" className="text-gray-600 dark:text-gray-400 data-[state=active]:bg-red-500 data-[state=active]:text-white">
            Blockerade Tider
          </TabsTrigger>
          <TabsTrigger value="extra" className="text-gray-600 dark:text-gray-400 data-[state=active]:bg-green-500 data-[state=active]:text-white">
            Extra Tidsluckor
          </TabsTrigger>
        </TabsList>
            ...
            <CardContent>
              {showCalendar ? (
                ...
                <div className="grid grid-cols-7 gap-4">
                  {DAYS_OF_WEEK.map((day, index) => (
                    <div key={index} className="space-y-2">
                      <h3 className="text-sm font-semibold text-blue-600 dark:text-blue-400 text-center">
                        {day}
                      </h3>
                      <div className="space-y-2">
                        {slotsByDay[index]?.map((slot) => (
                          <div
                            key={slot.id}
                            className="p-3 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors cursor-pointer group"
                            ...
                            <div className="flex items-center justify-between mt-1">
                              ...
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                                <Button
                                  size="sm"
                                  variant="outline"
                                  className="h-6 w-6 p-0 border-gray-300 text-gray-600 hover:bg-gray-100 dark:border-gray-500 dark:text-gray-400 dark:hover:bg-gray-600"
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    setEditingSlot(slot);
                                  }}
                        ...
                        <Button
                          ...
                          className="w-full border-gray-300 text-gray-600 hover:bg-gray-100 dark:border-gray-500 dark:text-gray-400 dark:hover:bg-gray-600 text-xs"
                        >
                ...
                <div className="space-y-4">
                  {slots.map((slot) => (
                    <div key={slot.id} className="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600">
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          variant="outline"
                          onClick={() => setEditingSlot(slot)}
                          className="border-gray-300 text-gray-600 hover:bg-gray-100 dark:border-gray-500 dark:text-gray-400 dark:hover:bg-gray-600"
                        >
            ...
            <CardContent>
              <div className="space-y-4">
                {blockedSlots.map((blocked) => (
                  <div key={blocked.id} className="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600">
                    <div className="flex items-center gap-4">
            ...
            <CardContent>
              <div className="space-y-4">
                {extraSlots.map((extra) => (
                  <div key={extra.id} className="flex items-center justify-between p-4 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600">
                    <div className="flex items-center gap-4">
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[90]">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Lägg till Tidslucka</h3>
              <Button
                variant="ghost"
                size="sm"
            ...
            <div className="p-6 space-y-4">
              <div>
                <Label className="text-gray-700 dark:text-gray-300">Veckodag</Label>
                <Select
                  value={slotForm.dayOfWeek.toString()}
                  onValueChange={(value) => setSlotForm({...slotForm, dayOfWeek: parseInt(value)})}
                >
                  <SelectTrigger className="border-gray-300 text-gray-900 focus:border-blue-500 dark:border-gray-600 dark:text-white dark:focus:border-blue-400">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    {DAYS_OF_WEEK.map((day, index) => (
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="text-gray-700 dark:text-gray-300">Starttid</Label>
                  <Input
                    type="time"
                    value={slotForm.timeStart}
                    onChange={(e) => setSlotForm({...slotForm, timeStart: e.target.value})}
                    className="border-gray-300 text-gray-900 focus:border-blue-500 dark:border-gray-600 dark:text-white dark:focus:border-blue-400"
                  />
                </div>
                <div>
                  <Label className="text-gray-700 dark:text-gray-300">Sluttid</Label>
                  <Input
                    type="time"
      ...
      {showAddBlocked && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[90]">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Lägg till Blockerad Tid</h3>
              <Button
                variant="ghost"
                size="sm"
            ...
            <div className="p-6 space-y-4">
              <div>
                <Label className="text-gray-700 dark:text-gray-300">Datum</Label>
                <Input
                  type="date"
                  value={blockedForm.date}
                  onChange={(e) => setBlockedForm({...blockedForm, date: e.target.value})}
                  className="border-gray-300 text-gray-900 focus:border-red-500 dark:border-gray-600 dark:text-white dark:focus:border-red-400"
                />
              </div>
              <div className="flex items-center gap-2">
                ...
                />
                <Label className="text-gray-700 dark:text-gray-300">Hela dagen</Label>
              </div>
              ...
              <div>
                <Label className="text-gray-700 dark:text-gray-300">Anledning (valfritt)</Label>
                <Input
                  type="text"
      ...
      {showAddExtra && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[90]">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Lägg till Extra Tidslucka</h3>
              <Button
                variant="ghost"
                size="sm"
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <Input
                  ...
                  className="border-gray-300 text-gray-900 focus:border-green-500 dark:border-gray-600 dark:text-white dark:focus:border-green-400"
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
              ...
              <div>
                <Label className="text-gray-700 dark:text-gray-300">Reservera för användare (valfritt)</Label>
                <Select
                ...
                >
                  <SelectTrigger className="border-gray-300 text-gray-900 focus:border-green-500 dark:border-gray-600 dark:text-white dark:focus:border-green-400">
                    <SelectValue placeholder="Synlig för alla" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="ALL">Synlig för alla</SelectItem>
      ...
      {editingSlot && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[90]">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Redigera Tidslucka</h3>
              <Button
                variant="ghost"
                size="sm"
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <Label className="text-gray-700 dark:text-gray-300">Aktiv</Label>
              </div>
              <div className="flex gap-3 justify-end pt-4 border-t border-gray-200 dark:border-gray-700">
                <Button
                  variant="outline"
      ...
      {/* Edit Extra Slot Modal */}
      {editingExtra && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[90]">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Redigera Extra Tidslucka</h3>
              <Button
                variant="ghost"
                size="sm"
