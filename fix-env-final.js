...
// Create .env.local with single-line DATABASE_URL
...
console.log('✅ Created .env.local with single-line DATABASE_URL');
console.log('🔐 Environment variables should now load correctly');
